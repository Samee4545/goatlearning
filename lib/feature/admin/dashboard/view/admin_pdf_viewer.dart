...
class AdminPdfViewer extends StatefulWidget {
  final String title;
  final String? id;
  final String pdfUrl;
  final String? path;
  ...
  @override
  State<AdminPdfViewer> createState() => _AdminPdfViewerState();
}

class _AdminPdfViewerState extends State<AdminPdfViewer> {
